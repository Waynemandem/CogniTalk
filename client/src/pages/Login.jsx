    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "linear-gradient(160deg, #0d1117 0%, #161b27 60%, #0d1117 100%)", fontFamily: "'Nunito', sans-serif" }}>
      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-white mb-1" style={{ letterSpacing: "-0.3px" }}>Welcome Back!</h1>
          <p className="text-sm mb-8" style={{ color: "rgba(255,255,255,0.4)" }}>Please sign in to your account</p>
          ...
          <div className="w-full flex justify-end mb-6">
            <Link to="/forgot-password" className="text-xs transition-colors" style={{ color: "rgba(255,255,255,0.35)" }}>
              Forgot Password?
            </Link>
          </div>
          ...
          <button
            ...
            onMouseEnter={e => !loading && (e.target.style.background = "#3b5bdb")}
            onMouseLeave={e => (e.target.style.background = "#4c6ef5")}
          >
            {loading ? (
              <>
          ...
          <p className="text-sm mt-6" style={{ color: "rgba(255,255,255,0.35)" }}>
            ...
            <Link to="/signup" className="font-bold" style={{ color: "#4c6ef5" }}>
              Sign Up
            </Link>
          </p>
        </div>
